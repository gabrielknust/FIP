		...
		<div class="">
			...
			<form class="contact1-form" method="post" action="#">
				...
				<div class="wrap-input1 validate-input" data-validate = "Usuário é requerida" >
					<input class="input1" type="text" name="usuario" placeholder="Usuário" required>
					<span class="shadow-input1"></span>
				</div>

				<div class="wrap-input1 validate-input" data-validate = "Senha é requerida" >
					<input class="input1" type="password" name="senha" placeholder="Senha" required>
					<span class="shadow-input1"></span>
				</div>

				<div class="container-contact1-form-btn">
					<button class="contact1-form-btn botao-azul" onclick="goBack()">
						<span>
							Voltar
